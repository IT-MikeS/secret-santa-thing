<template>
  <div class="flex min-h-screen max-h-screen p-0 m-0">
    <Button
    ...
    <Drawer v-model:visible="showSidebar">
      <template #header>
    ...
    <div class="flex justify-content-center flex-wrap flex-grow-1">
      <div class="flex align-items-center justify-content-center">
        <Card class="px-5 py-3" style="min-width: 450px;">
          <template #title>
